									...
									<div>
										...
										{session && (
											<div className="flex flex-col items-center">
												<span className="mb-4 whitespace-nowrap inline-flex items-center justify-center px-3 py-1 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-indigo-600">
													{session.user.name || session.user.email}
												</span>
												<a
													href={'/api/auth/signout'}
